...
const $$Tanghuot = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "MooncakePage", $$MooncakePage, { "lang": "en" })}`;
}, "C:/Projects/CKM/src/pages/en/tanghuot.astro", void 0);

const $$file = "C:/Projects/CKM/src/pages/en/tanghuot.astro";
const $$url = "/en/tanghuot";
